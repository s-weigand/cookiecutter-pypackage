...
# source_suffix = '.rst'
linkcheck_ignore = [
    r"https://github\.com/{{ cookiecutter.github_username }}/{{ cookiecutter.project_slug_url }}/actions",
    r"https://github\.com/{{ cookiecutter.github_username }}/{{ cookiecutter.project_slug_url }}/workflows/Tests/badge\.svg",
]
